...
class Product(models.Model):
    ...
    unit= models.ForeignKey(Unit_Type, on_delete=models.CASCADE,  default='piece')
    ...
    Manufacturer = models.ForeignKey(User, limit_choices_to= { 'groups__name': 'Manufacturer'}, on_delete=models.CASCADE, default=1)

...
from .views import *
from .views import Cart, Checkout, OrderView, ViewManufact
...
urlpatterns = [
    ...
    path('manufact_registration', views.manufact_reg, name = 'fa_reg'),
    path('officer_registration', views.staff_officer_reg, name = 'agri_officer_reg'),
    ...
    path('viewFar/<int:pk>', ViewManufact.as_view(), name='farmerDetails'),
